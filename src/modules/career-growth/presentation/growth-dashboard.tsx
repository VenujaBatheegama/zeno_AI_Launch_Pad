      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-4 sm:shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-red-500/20 bg-red-500/10 px-2.5 py-1.5 text-xs font-semibold text-red-400 hover:bg-red-500/20 hover:border-red-500/40 transition"
          >
            <svg
