...
export function PasteJdForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form
        onSubmit={onSubmit}
        className="space-y-5 rounded-[16px] border border-[var(--zeno-border)] bg-white p-6 shadow-[var(--zeno-shadow-sm)]"
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="block space-y-1.5">
            ...
            <input
              ...
              disabled={loading}
              className="h-10 w-full rounded-[var(--zeno-radius-sm)] border border-[var(--zeno-border)] bg-white px-3 text-[13px] outline-none transition focus:border-[var(--zeno-primary)] disabled:opacity-60"
            />
          </label>
        ...
        <label className="block space-y-1.5">
          ...
          <textarea
            ...
            required
            className="w-full rounded-[var(--zeno-radius-sm)] border border-[var(--zeno-border)] bg-white p-3 font-mono text-[13px] leading-relaxed outline-none transition focus:border-[var(--zeno-primary)] disabled:opacity-60"
          />
        </label>
